    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form  action="<?php echo BEGIN_PATH ?>/student/index" method="POST" 
                ...
                <div class="form-group row">
                  ...
                  <div class="form-footer">
                    <a href="<?=BEGIN_PATH?>/student" class="btn btn-danger">Back</a>
                  </div>
              </form>
            </div>
          </div>
