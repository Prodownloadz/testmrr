    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form  action="<?php echo BEGIN_PATH ?>/salesperson/index" method="POST" 
                enctype="multipart/form-data"  autocomplete="off">
                <h4 class="form-header text-uppercase"><i class="fa fa-user-circle-o"></i>Student Details View</h4>

                 <div class="form-group row">
                  <label for="input-8" class="col-sm-2 col-form-label">Salesperson Name :</label>
                  <div class="col-sm-6"><?=$content[0]['salesperson_name']?>  <?=$content[0]['salesperson_lastname']?>
                  </div>
                </div>
                
                <div class="form-group row">
                  <label for="input-8" class="col-sm-2 col-form-label">Salesperson Mobile :</label>
                  <div class="col-sm-6"><?=$content[0]['salesperson_mobile']?>
                   
                  </div>
                </div>  
                <div class="form-group row">
                  <label for="input-8" class="col-sm-2 col-form-label">Salesperson Email :</label>
                  <div class="col-sm-6"><?=$content[0]['salesperson_email']?>
                  ...
                  <div class="form-footer">
                    <a href="<?=BEGIN_PATH?>/salesperson" class="btn btn-danger">Back</a>
                  </div>
              </form>
            </div>
          </div>
