    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-10">
          <div class="card">
            <div class="card-body">
              <form  action="<?php echo BEGIN_PATH ?>/banner/index" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                    ...
                    <label for="input-8" class="col-sm-2 col-form-label">Image :</label>
                      <div class="col-sm-10">
                        <?php
                          ...
                          {
                        ?> 
                          <img src="<?php echo BEGIN_PATH ?>/webupload/original/<?=$content[0]['web_image']?>" style="width:300px; height:100px;"  border="0"/>
                        <?php
                          } 
                        ?>
                      </div>
                  </div>
                  <input type="hidden" name="banner_id" value="<?=$content[0]['banner_id']?>">
                  <div class="form-footer">
                    <a href="<?=BEGIN_PATH?>/banner" class="btn btn-danger">Back</a>
                  </div>
              </form>
            </div>
          </div>
