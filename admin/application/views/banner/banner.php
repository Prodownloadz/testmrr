  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><span> Brand</span> 
              <a href="<?php echo BEGIN_PATH ?>/banner/banneradd" class="btn btn-success btn-sm waves-effect waves-light m-1" style="float:right;">ADD</a>
            </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        ...
                        <td>
                          <a href="<?php echo BEGIN_PATH ?>/banner/banneredit?banner_id=<?=$value['banner_id']?>"><button class="btn btn-info waves-effect waves-light m-1"><i class="fa fa-edit"></i>
                          </button></a>
                          <a href="<?php echo BEGIN_PATH ?>/banner/bannerview?banner_id=<?=$value['banner_id']?>"><button class="btn btn-warning waves-effect waves-light m-1">
                            <i class="fa fa-eye" aria-hidden="true"></i></button></a>
                          <a href="<?php echo BEGIN_PATH?>/banner/del?did=<?=$value['banner_id']?>" 
