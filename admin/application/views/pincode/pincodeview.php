    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form  action="<?php echo BEGIN_PATH ?>/pincode/index" method="POST" 
                ...
                <h4 class="form-header text-uppercase"><i class="fa fa-user-circle-o"></i>Pincode</h4>
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-6"><?=$content[0]['web_pincode']?>
                  </div>
                </div>
                
                <div class="form-group row">
                  <label for="input-8" class="col-sm-2 col-form-label">Price :</label>
                  <div class="col-sm-6"><?=$content[0]['web_price']?>
                  ...
                  <div class="form-footer">
                    <a href="<?=BEGIN_PATH?>/pincode" class="btn btn-danger">Back</a>
                  </div>
              </form>
            </div>
          </div>
