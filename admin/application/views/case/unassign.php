  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Processing Cases</h4>
                 ...
                 <?php   if($value['delivery_date']!=''){ ?>
                        ...
                        <td>
                            ...
                            <select class="form-control" name="accept_status" id="accept_status<?=$i?>"  onChange="return get(<?=$i?>);">
                                ...
                                <option <?php if($value['status']=="Open"){ echo 'selected';} ?>  value="Open">Open</option>
                                <option <?php if($value['status']=="Processing"){ echo 'selected';} ?>  value="Processing">Processing</option>
                                <option <?php if($value['status']=="Completed"){ echo 'selected';} ?> value="Completed">Completed</option>
                            </select>
                        </td>
                        <td>
