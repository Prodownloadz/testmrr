  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Cases List</h4>
              ...
              <table id="example" class="table table-bordered">
                <thead style="background-color: #88a8b1;color: white;">
                    <tr>
                        <th>S.No</th>
                         <th>User Name</th>
                         <th>Attorney or Requestor Name</th>
                         <th>Firm Name</th>
                         <th>Contact Name</th>
                        ...
                        <th>Country Name</th>
                        <th>State</th>
                        <th> Review Services </th>
                        <th> Add on Services  </th>
                        <th> Medical Charts </th>
        ...
        $name=$arr['content1'][0]['name'];
                  ?>
                    <tr>
                        ...
                        <td><?=$value['phone']?> </td>
                        <td><?=$value['emailone']?> </td>
                        <td><?=$value['emailtwo']?> </td>
                        <td><?=$value['casename']?> </td>
                        <td><?=$value['casetype']?> </td>
                        
                        <td><?=$value['casedescription']?> </td>
                        <td><?=$value['txtcountry']?> </td>
                        <td><?=$value['state']?> </td>
                        <td><?=$value['review_services']?> </td>
                        <td><?=$value['add_on_services']?> </td>
                        <td><?=$value['medical_charts']?> </td>
                        <td><?=$value['date']?></td>
                        <td><?=$value['note']?></td>
                        ...
                        <td>
                          ...
                          <a href="<?php echo BEGIN_PATH ?>/newcases/newcaseview?cid=<?=$value['id']?>">
                            <button class="btn btn-warning waves-effect waves-light m-1">
                            <i class="fa fa-eye" aria-hidden="true"></i></button>
                          </a>
                           <a href="<?php echo BEGIN_PATH?>/newcases/del?did=<?=$value['id']?>" 
