  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><span> Pincode</span> 
             <a href="<?php echo BEGIN_PATH ?>/pincode/pincodeadd" class="btn btn-success btn-sm waves-effect waves-light m-1" style="float:right;">ADD</a>
            </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        ...
                        <td><?=$value['web_pincode']?></td>
                        <td><?=$value['web_price']?></td>
                        
                        <td>
                          <a href="<?php echo BEGIN_PATH ?>/pincode/pincodeedit?pin_id=<?=$value['pin_id']?>"><button class="btn btn-info waves-effect waves-light m-1"><i class="fa fa-edit"></i>
                          </button></a>
                          <a href="<?php echo BEGIN_PATH ?>/pincode/pincodeview?pin_id=<?=$value['pin_id']?>"><button class="btn btn-warning waves-effect waves-light m-1">
                            <i class="fa fa-eye" aria-hidden="true"></i></button></a>
                          <a href="<?php echo BEGIN_PATH?>/pincode/del?did=<?=$value['pin_id']?>" 
