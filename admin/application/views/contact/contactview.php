    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form  action="<? echo BEGIN_PATH ?>/category/index" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                <h4 class="form-header text-uppercase"><i class="fa fa-user-circle-o"></i>Contact</h4>

                <div class="form-group row">
                  <label for="input-8" class="col-sm-2 col-form-label">Ownername :</label>
                 ...
                 <!--<div class="form-group row">
                  <label for="input-8" class="col-sm-2 col-form-label">Re Email :</label>
                     <div class="col-sm-10"><?=$content[0]['email1']?></div>
                </div>-->
                 <div class="form-group row">
                 ...
                 <!--<div class="form-group row">
                  <label for="input-8" class="col-sm-2 col-form-label">Re Mobile :</label>
                     <div class="col-sm-10"><?=$content[0]['mobile1']?></div>
                </div>-->
                <div class="form-group row">
                  <label for="input-8" class="col-sm-2 col-form-label">Address :</label>
                     <div class="col-sm-10"><?=$content[0]['address']?></div>
                </div>
                <!--<div class="form-group row">
                  <label for="input-8" class="col-sm-2 col-form-label">Re Address :</label>
                     <div class="col-sm-10"><?=$content[0]['address1']?></div>
                </div>-->

                 
                  <input type="hidden" name="cat_id" value="<?=$content[0]['cat_id']?>">
                  <div class="form-footer">
                    <a href="<?=BEGIN_PATH?>/contact" class="btn btn-danger">Back</a>
                  </div>
              </form>
            </div>
          </div>
