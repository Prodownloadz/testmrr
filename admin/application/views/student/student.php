  ...
  <div class="content-wrapper">
    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><span> Student Details</span> 
             <a href="<?php echo BEGIN_PATH ?>/student/studentadd" class="btn btn-success btn-sm waves-effect waves-light m-1" style="float:right;">ADD</a>
            </div>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                        ...
                        <td>
                          <a href="<?php echo BEGIN_PATH ?>/student/studentedit?id=<?=$value['id']?>"><button class="btn btn-info waves-effect waves-light m-1"><i class="fa fa-edit"></i>
                          </button></a>
                          <a href="<?php echo BEGIN_PATH ?>/student/studentview?id=<?=$value['id']?>"><button class="btn btn-warning waves-effect waves-light m-1">
                            <i class="fa fa-eye" aria-hidden="true"></i></button></a>
                          <a href="<?php echo BEGIN_PATH?>/student/del?did=<?=$value['id']?>" 
