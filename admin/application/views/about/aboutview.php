    ...
    <!-- End Breadcrumb-->
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <form  action="<? echo BEGIN_PATH ?>/about/index" method="POST" enctype="multipart/form-data"
                autocomplete="off">
                <h4 class="form-header text-uppercase"><i class="fa fa-user-circle-o"></i>About - View</h4>

                <div class="form-group row">
                  <label for="input-8" class="col-sm-2 col-form-label">Title :</label>
                     <div class="col-sm-10"><?=$content[0]['web_title']?></div>
                </div>
                <div class="form-group row">
                    <label for="input-8" class="col-sm-2 col-form-label">Image :</label>
                      <div class="col-sm-10">
                        <?php
                          ...
                          {
                        ?> 
                          <img src="<? echo BEGIN_PATH ?>/webupload/original/<?=$content[0]['web_image']?>" style="width:300px; height:100px;"  border="0"/>
                        <?php
                          } 
                        ?>
                      </div>
                 ...
                 <div class="form-group row">
                  <label for="input-8" class="col-sm-2 col-form-label">Description :</label>
                     <div class="col-sm-10"><?=$content[0]['web_content']?></div>
                </div>
                 
                  <input type="hidden" name="id" value="<?=$content[0]['id']?>">
                  <div class="form-footer">
                    <a href="<?=BEGIN_PATH?>/about" class="btn btn-danger">Back</a>
                  </div>
              </form>
            </div>
          </div>
