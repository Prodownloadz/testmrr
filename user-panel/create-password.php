                    ...
                    <div class="containers left-con">
                        ...
                        <div class="form-container">
                            <div class="form-login">
                                <h5 class="title">Create a Password</h5>
                                <div class="form-group">
                                    <label>Email</label>
                                    <div class="form-icon-group">
                                        <span><i class="far fa-user"></i></span>
                                        <input type="text" class="email form-control" placeholder="Enter your email" value="<?= $email; ?>" disabled="">
                                    </div>
                                ...
                                <div class="form-group btn-groups">
                                    ...
                                    <button class="create-pass-btn btn btn-md btn-custom">Submit</button>
                                </div>
                            </div>
    ...
    <script type="text/javascript">
        ...
        $('.password, .confirm_password').keyup(function () {
            ...
            if (password1 !== password2) {
                ...
                $('.create-pass-btn').css("display", "none");
            } else {
                $('.password_error_msg').css("display", "none");
                $('.create-pass-btn').css("display", "block");
            }
        });
        ...
        $('.create-pass-btn').click(function () {
            var Data = [];
            var Error = [];
            ...
            if (Error.length === 0) {
                $.ajax({
                    type: 'POST',
                    url: './trans.php',
                    data: {'Id': 'create-password', 'Data': Data},
